...
YUI().use('node', function (Y) {
    ...
    var embedCode       = '<iframe id="vimeo_iframe" src="' + vimeoURL + '?title=0&amp;byline=0&amp;portrait=0&amp;color=' + playerColor + '&amp;autoplay=1&amp;api=1&amp;player_id=overplay" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
